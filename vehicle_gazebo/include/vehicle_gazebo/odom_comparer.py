...
class OdometryComparer(Node):
    ...
    def init_plots(self):
        ...
        self.win.setWindowTitle('Odometry Comparison')
        ...
        # ---- Row 2 ----
        self.axErrX = self.win.addPlot(title='Position Error X (m)')
        self.err_x_curve = self.axErrX.plot(pen='r')

        self.axErrY = self.win.addPlot(title='Position Error Y (m)')
        self.err_y_curve = self.axErrY.plot(pen='b')

        self.win.nextRow()

        # ---- Row 3 ----
        self.ax4 = self.win.addPlot(title='Linear Velocity (m/s)')
        ...
        # ---- Row 4 ----
        self.axVxErr = self.win.addPlot(title='Linear Velocity Error (m/s)')
